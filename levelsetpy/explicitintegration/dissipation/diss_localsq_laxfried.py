__all__ = ["artificia.dissipationLLLF"]
...
def artificialDissipationLLLF(t, data, derivL, derivR, schemeData):
    """
    artificia.dissipationLLLF: local Lax-Friedrichs dissipation calculation.

    [ diss, stepBound ] = ...
                artificia.dissipationLLLF(t, data, derivL, derivR, schemeData)
