__all__ = ["artificia.dissipationGLF"]
...
def artificialDissipationGLF(t, data, derivL, derivR, schemeData):
    """
     artificia.dissipationGLF: (global) Lax-Friedrichs dissipation calculation.

     diss, stepBound =artificia.dissipationGLF(t, data, derivL, derivR, schemeData)
