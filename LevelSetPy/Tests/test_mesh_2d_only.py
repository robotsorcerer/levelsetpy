...
def levelset_viz(g, ax, fig, mesh, title='', savedict=None, fontdict=None, fc='c', ec='k'):
	...
	# ax.set_title(f'{title}', fontdict=fontdict)
	ax.set_xticks([])
	ax.set_yticks([])
	ax.set_zticks([])
...
def main(savedict):
	...
	savedict["savename"]="sphere2_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')

	levelset_viz(g2, ax, fig, sphere2, title='Sphere', savedict=savedict, fontdict={'fontsize':22, 'fontweight':'bold'})
	plt.pause(args.delay)

	savedict["savename"]="rect_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="rect2_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="rect3_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="rect4_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	# Show Unions
	savedict["savename"]="sphere_union_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="rect_union_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="rect_comp_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
	...
	savedict["savename"]="sph_rect_diff_2d.jpeg"
	plt.clf()
	# ax = [plt.subplot(gs[i], projection='3d') for i in range(2)] + [plt.subplot(gs[2])]
	ax = fig.add_subplot(111, projection='3d')
...
if __name__ == '__main__':
	savedict = dict(save=True, savename='cyl_2d.jpeg',\
